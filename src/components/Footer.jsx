...
const Footer = () => {
  return (
    <>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-violet-800 to-violet-900 ">
        <div className="flex md:flex-row flex-col md:justify-between items-center text-white gap-4">
